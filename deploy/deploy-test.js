...
var remotes = {
  servers: [
    {
      host: '120.132.115.201',
      user: 'root',
      password: 'locisiongo@2017',
    },
  ],
  projectName: 'web-client-test',
  projectSpace: '/root/deploy/community/web-middleware',
  scriptPath: '/root/deploy/community/web-middleware/web-middleware/web-client',
  backupPath: '/root/deploy/community/web-middleware/backup',
}
