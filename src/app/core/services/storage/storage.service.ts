...
export class MemoryStorage implements IStorage {
    ...
    getAll(pool: string): any {
        return this.storages.has(pool) ? this.storages.get(pool) : new Map<string, Object>();
    }
...
export class StorageService {
    ...
    put({ pool, key, storageType }: { pool?: string, key: string, storageType?: StorageType }, value: Object): void {
        const storage: IStorage = <IStorage> this.storages.get(storageType || this.defaultStorageType);
